...
$activePage = 'unclaimed';
require_once 'includes/layout.php';
?>

<div class="data-management-card" style="margin-top: 1rem;">
    <h2 style="margin-bottom: 1.5rem; color: var(--airtel-red);">Unclaimed Assets</h2>
    
    <form method="GET" action="unclaimed.php" class="filters-row">
        ...
        <div class="filter-controls">
            ...
            <?php if ($search !== '' || $letterFilter !== ''): ?>
                <a href="unclaimed.php" class="btn-reset">Reset</a>
            <?php endif; ?>
        </div>
    </form>
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php if (empty($assets)): ?>
                    <tr><td colspan="8"><div class="empty-state"><p>No unclaimed records found.</p></div></td></tr>
                <?php else: ?>
                    <?php $itemIndex = $offset + 1; foreach ($assets as $asset): ?>
                        <tr id="row-<?= $asset['record_id'] ?>">
                            ...
                            <td style="text-align: center;">
                                <span class="status-badge unclaimed"><i class="fa-solid fa-hourglass-half"></i> <span>Unclaimed</span></span>
                            </td>
                            <td style="text-align: center;">
