...
<div class="data-management-card" id="records-section" style="margin-top: 1rem;">
    ...
    <form method="GET" action="unclaimed.php#records-section" class="filters-panel">
    ...
    <?php if ($totalPages > 1): ?>
    <?php
        $paginationBase = 'unclaimed.php?owner_name=' . urlencode($ownerNameFilter)
